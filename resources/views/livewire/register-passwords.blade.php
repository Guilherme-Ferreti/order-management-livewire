<div>
    ...
    <div class="mt-4">
        ...
        <div class="flex mt-1 mb-2"> 
            <div class="relative flex-1 col-span-4" x-data="{ show: false }">
                <input class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 pr-10"
                        id="password"
        ...
        <span class="text-sm">
            <span class="font-semibold">Password strength:</span> {{ $this->getPasswordStrengthLabel() }}
        </span>
